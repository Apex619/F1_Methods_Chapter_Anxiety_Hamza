...
indiv_tot_dist_tank <-ggplot(individual_means_tot_dist_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  labs(y="Mean total distance travelled (cm)")
...
indiv_low_dur_tank <-ggplot(individual_means_low_dur_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean time spent in low zone (seconds)")
...
indiv_mid_dur_tank <-ggplot(individual_means_mid_dur_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean time spent in mid zone (seconds)")
...
indiv_high_dur_tank <-ggplot(individual_means_high_dur_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean time spent in high zone (seconds)")
...
indiv_freezing_dur_tank <-ggplot(individual_means_freezing_dur_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean time spent freezing (seconds)")
...
indiv_latency_high_tank <-ggplot(individual_means_latency_high_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean latency to high zone (seconds)")
...
indiv_entries_tank <-ggplot(individual_means_entries_tank, aes(Tank, Mean, fill=Tank)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean entries to high zone")
...
indiv_tot_dist <-ggplot(individual_means_tot_dist, aes(Sex, Mean, fill=Sex)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean total distance travelled")
...
indiv_low <-ggplot(individual_means_low, aes(Sex, Mean, fill=Sex)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean time spent in low zone")
...
indiv_mid <-ggplot(individual_means_mid, aes(Sex, Mean, fill=Sex)) + 
  ...
  theme(axis.ticks.x=element_blank(),
       axis.title.x=element_blank())+
  labs(y="Mean time spent in mid zone")
...
```{r}
Joined_violins <- Violin_Dist + Violin_Low + Violin_Mid + Violin_High + Violin_Freezing + Violin_Latency+Violin_entries + plot_layout(ncol = 2, nrow=4)+ grid::textGrob('Important text')

Joined_violins

Joined_violins_indiv_sex_tank <- indiv_tot_dist + indiv_low + indiv_mid + indiv_high + indiv_freezing + indiv_latency+indiv_freq + plot_layout(ncol = 2, nrow=4)+ grid::textGrob('Important text')

Joined_violins_indiv_sex_tank

Joined_violins_indiv_tank <- indiv_tot_dist_tank + indiv_low_dur_tank + indiv_mid_dur_tank + indiv_high_dur_tank + indiv_freezing_dur_tank + indiv_latency_high_tank+indiv_entries_tank + plot_layout(ncol = 2, nrow=4)+ grid::textGrob('Important text')
