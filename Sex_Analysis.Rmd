...
quantile(Diff_boot_Tot_Dist_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_Tot_Dist_old)
...
quantile(Diff_boot_Tot_Dist_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_Tot_Dist_tall)
...
quantile(Diff_boot_low_dur_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_low_dur_old)
...
quantile(Diff_boot_low_dur_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_low_dur_tall)
...
quantile(Diff_boot_mid_dur_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_mid_dur_old)
...
quantile(Diff_boot_mid_dur_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_mid_dur_tall)
...
Diff_boot_high_dur_old <- Old_high_dur_Male_boot - Old_high_dur_Female_boot
hist(Diff_boot_high_dur_old, breaks = 50)

quantile(Diff_boot_high_dur_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_high_dur_old)
...
quantile(Diff_boot_high_dur_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_high_dur_tall)
```
...
quantile(Diff_boot_freezing_dur_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_freezing_dur_old)
...
quantile(Diff_boot_freezing_dur_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_freezing_dur_tall)
...
quantile(Diff_boot_latency_high_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_latency_high_old)
...
quantile(Diff_boot_latency_high_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_latency_high_tall)
```
...
Diff_boot_freq_high_old <- Old_freq_high_Male_boot - Old_freq_high_Female_boot
hist(Diff_boot_freq_high_old, breaks = 50)

quantile(Diff_boot_freq_high_old, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_freq_high_old)
...
quantile(Diff_boot_freq_high_tall, c(0.025, 0.975)) # difference ditribuiton 95% CI
mean(Diff_boot_freq_high_tall)
...
low_dur_rptr_sex <- tibble(
  Tank_Type = c("Short","Short", "Tall", "Tall"),
  Sex = c("Male","Female","Male", "Female"),
  r = c(Old_low_dur_Male$R$Fish_ID,Old_low_dur_Female$R$Fish_ID,Tall_low_dur_Male$R$Fish_ID,Tall_low_dur_Female$R$Fish_ID ),
  ci.lb = c(Old_low_dur_Male$CI_emp$`2.5%`,Old_low_dur_Female$CI_emp$`2.5%`,Tall_low_dur_Male$CI_emp$`2.5%`,Tall_low_dur_Female$CI_emp$`2.5%`),
  ci.ub = c(Old_low_dur_Male$CI_emp$`97.5%`,Old_low_dur_Female$CI_emp$`97.5%`,Tall_low_dur_Male$CI_emp$`97.5%`,Tall_low_dur_Female$CI_emp$`97.5%`))

low_dur_rptr_sex

plot_low_dur_rptr_sex <- ggplot(low_dur_rptr_sex, aes(x=Tank_Type, y=r, colour=Sex)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3)) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
...
mid_dur_rptr_sex <- tibble(
  Tank_Type = c("Short","Short", "Tall", "Tall"),
  Sex = c("Male","Female","Male", "Female"),
  r = c(Old_mid_dur_Male$R$Fish_ID,Old_mid_dur_Female$R$Fish_ID,Tall_mid_dur_Male$R$Fish_ID,Tall_mid_dur_Female$R$Fish_ID ),
  ci.lb = c(Old_mid_dur_Male$CI_emp$`2.5%`,Old_mid_dur_Female$CI_emp$`2.5%`,Tall_mid_dur_Male$CI_emp$`2.5%`,Tall_mid_dur_Female$CI_emp$`2.5%`),
  ci.ub = c(Old_mid_dur_Male$CI_emp$`97.5%`,Old_mid_dur_Female$CI_emp$`97.5%`,Tall_mid_dur_Male$CI_emp$`97.5%`,Tall_mid_dur_Female$CI_emp$`97.5%`))

mid_dur_rptr_sex

plot_mid_dur_rptr_sex <- ggplot(mid_dur_rptr_sex, aes(x=Tank_Type, y=r, colour=Sex)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3)) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank type", y = "r") +
...
high_dur_rptr_sex <- tibble(
  Tank_Type = c("Short","Short", "Tall", "Tall"),
  Sex = c("Male","Female","Male", "Female"),
  r = c(Old_high_dur_Male2$R$Fish_ID,Old_high_dur_Female2$R$Fish_ID,Tall_high_dur_Male2$R$Fish_ID,Tall_high_dur_Female2$R$Fish_ID ),
  ci.lb = c(Old_high_dur_Male2$CI_emp$`2.5%`,Old_high_dur_Female2$CI_emp$`2.5%`,Tall_high_dur_Male2$CI_emp$`2.5%`,Tall_high_dur_Female2$CI_emp$`2.5%`),
  ci.ub = c(Old_high_dur_Male2$CI_emp$`97.5%`,Old_high_dur_Female2$CI_emp$`97.5%`,Tall_high_dur_Male2$CI_emp$`97.5%`,Tall_high_dur_Female2$CI_emp$`97.5%`))

high_dur_rptr_sex

plot_high_dur_rptr_sex <- ggplot(high_dur_rptr_sex, aes(x=Tank_Type, y=r, colour=Sex)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3)) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
...
freezing_dur_rptr_sex <- tibble(
  Tank_Type = c("Short","Short", "Tall", "Tall"),
  Sex = c("Male","Female","Male", "Female"),
  r = c(Old_freezing_dur_Male3$R$Fish_ID,Old_freezing_dur_Female3$R$Fish_ID,Tall_freezing_dur_Male3$R$Fish_ID,Tall_freezing_dur_Female3$R$Fish_ID ),
  ci.lb = c(Old_freezing_dur_Male3$CI_emp$`2.5%`,Old_freezing_dur_Female3$CI_emp$`2.5%`,Tall_freezing_dur_Male3$CI_emp$`2.5%`,Tall_freezing_dur_Female3$CI_emp$`2.5%`),
  ci.ub = c(Old_freezing_dur_Male3$CI_emp$`97.5%`,Old_freezing_dur_Female3$CI_emp$`97.5%`,Tall_freezing_dur_Male3$CI_emp$`97.5%`,Tall_freezing_dur_Female3$CI_emp$`97.5%`))

freezing_dur_rptr_sex

plot_freezing_dur_rptr_sex <- ggplot(freezing_dur_rptr_sex, aes(x=Tank_Type, y=r, colour=Sex)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3)) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
...
latency_high_rptr_sex <- tibble(
  Tank_Type = c("Short","Short", "Tall", "Tall"),
  Sex = c("Male","Female","Male", "Female"),
  r = c(Old_latency_high_Male$R$Fish_ID,Old_latency_high_Female$R$Fish_ID,Tall_latency_high_Male$R$Fish_ID,Tall_latency_high_Female$R$Fish_ID ),
  ci.lb = c(Old_latency_high_Male$CI_emp$`2.5%`,Old_latency_high_Female$CI_emp$`2.5%`,Tall_latency_high_Male$CI_emp$`2.5%`,Tall_latency_high_Female$CI_emp$`2.5%`),
  ci.ub = c(Old_latency_high_Male$CI_emp$`97.5%`,Old_latency_high_Female$CI_emp$`97.5%`,Tall_latency_high_Male$CI_emp$`97.5%`,Tall_latency_high_Female$CI_emp$`97.5%`))

latency_high_rptr_sex

plot_latency_high_rptr_sex <- ggplot(latency_high_rptr_sex, aes(x=Tank_Type, y=r, colour=Sex)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3)) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
...
freq_high_rptr_sex <- tibble(
  Tank_Type = c("Short","Short", "Tall", "Tall"),
  Sex = c("Male","Female","Male", "Female"),
  r = c(Old_freq_high_Male$R$Fish_ID,Old_freq_high_Female$R$Fish_ID,Tall_freq_high_Male$R$Fish_ID,Tall_freq_high_Female$R$Fish_ID ),
  ci.lb = c(Old_freq_high_Male$CI_emp$`2.5%`,Old_freq_high_Female$CI_emp$`2.5%`,Tall_freq_high_Male$CI_emp$`2.5%`,Tall_freq_high_Female$CI_emp$`2.5%`),
  ci.ub = c(Old_freq_high_Male$CI_emp$`97.5%`,Old_freq_high_Female$CI_emp$`97.5%`,Tall_freq_high_Male$CI_emp$`97.5%`,Tall_freq_high_Female$CI_emp$`97.5%`))
