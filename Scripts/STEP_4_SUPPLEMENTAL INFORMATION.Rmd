...
plot(Model_Tot_Dist_water)
ggplot(Anxiety_Joined, aes(x = water_time, y = tot_dist) ) +
     geom_point() +
     geom_smooth(method = "lm", se = FALSE)

#Subset by Day to use as an example

Day1 <- subset(Anxiety_Joined, Anxiety_Joined$Date == "2/03/2020") 


Model_Tot_Dist_water_day1 <- lm(tot_dist ~ water_time, data = Day1)
hist(resid(Model_Tot_Dist_water_day1))
tab_model(Model_Tot_Dist_water_day1)
plot(Model_Tot_Dist_water_day1)
ggplot(Day1, aes(x = water_time, y = tot_dist) ) +
     geom_point() +
     geom_smooth(method = "lm", se = FALSE)
