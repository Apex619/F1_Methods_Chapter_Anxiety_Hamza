...
Tot_Dist_rptr <- tibble(
  Condition = c("Short", "Tall", "Contrast", "Between-Individual Variance", "Within-Individual Variance"),
  r = c(Old_Tot_Dist$R$Fish_ID,Tall_Tot_Dist$R$Fish_ID, m1, within_between_tot_dist_old$R[1], within_between_tot_dist_old$R[2]),
  ci.lb = c(Old_Tot_Dist$CI_emp$`2.5%`,Tall_Tot_Dist$CI_emp$`2.5%`,-0.01, within_between_tot_dist_old$CI_emp[1,1], within_between_tot_dist_old$CI_emp[2,1]),
  ci.ub = c(Old_Tot_Dist$CI_emp$`97.5%`,Tall_Tot_Dist$CI_emp$`97.5%`, 0.38, within_between_tot_dist_old$CI_emp[1,2], within_between_tot_dist_old$CI_emp[2,2]),
Endpoint = c("Total distance", "Total distance", "Total distance", "Total distance", "Total distance"))
...
low_dur_rptr <- tibble(
  Condition = c("Short", "Tall", "Contrast","Between-Individual Variance", "Within-Individual Variance"),
  r = c(Old_low_dur$R$Fish_ID,Tall_low_dur$R$Fish_ID, m2,within_between_low_dur_old$R[1], within_between_low_dur_old$R[2]),
  ci.lb = c(Old_low_dur$CI_emp$`2.5%`,Tall_low_dur$CI_emp$`2.5%`, 0.0004443611,within_between_low_dur_old$CI_emp[1,1], within_between_low_dur_old$CI_emp[2,1]),
  ci.ub = c(Old_low_dur$CI_emp$`97.5%`,Tall_low_dur$CI_emp$`97.5%`, 0.3583075307,within_between_low_dur_old$CI_emp[1,2], within_between_low_dur_old$CI_emp[2,2] ),
Endpoint = c("Time spent in low zone", "Time spent in low zone", "Time spent in low zone","Time spent in low zone","Time spent in low zone"))
...
mid_dur_rptr <- tibble(
  Condition = c("Short", "Tall", "Contrast","Between-Individual Variance", "Within-Individual Variance"),
  r = c(Old_mid_dur$R$Fish_ID,Tall_mid_dur$R$Fish_ID, m3,within_between_mid_dur_old$R[1], within_between_mid_dur_old$R[2]),
  ci.lb = c(Old_mid_dur$CI_emp$`2.5%`,Tall_mid_dur$CI_emp$`2.5%`, -0.13,within_between_mid_dur_old$CI_emp[1,1], within_between_mid_dur_old$CI_emp[2,1]),
  ci.ub = c(Old_mid_dur$CI_emp$`97.5%`,Tall_mid_dur$CI_emp$`97.5%`,0.21,within_between_mid_dur_old$CI_emp[1,2], within_between_mid_dur_old$CI_emp[2,2]),
Endpoint = c("Time spent in mid zone", "Time spent in mid zone", "Time spent in mid zone","Time spent in mid zone","Time spent in mid zone"))
...
high_dur_rptr <- tibble(
  Condition = c("Short", "Tall", "Contrast","Between-Individual Variance", "Within-Individual Variance"),
  r = c(Old_high_dur2$R$Fish_ID,Tall_high_dur2$R$Fish_ID, m4,within_between_high_dur_old$R[1], within_between_high_dur_old$R[2]),
  ci.lb = c(Old_high_dur2$CI_emp$`2.5%`,Tall_high_dur2$CI_emp$`2.5%`, -0.09,within_between_high_dur_old$CI_emp[1,1], within_between_high_dur_old$CI_emp[2,1]),
  ci.ub = c(Old_high_dur2$CI_emp$`97.5%`,Tall_high_dur2$CI_emp$`97.5%`, 0.22, within_between_high_dur_old$CI_emp[1,2], within_between_high_dur_old$CI_emp[2,2]),
Endpoint = c("Time spent in high zone", "Time spent in high zone", "Time spent in high zone","Time spent in high zone","Time spent in high zone"))
...
freezing_dur_rptr <- tibble(
  Condition = c("Short", "Tall", "Contrast","Between-Individual Variance", "Within-Individual Variance"),
  r = c(Old_freezing_dur3$R$Fish_ID,Tall_freezing_dur3$R$Fish_ID, m5, within_between_freezing_dur_old$R[1], within_between_freezing_dur_old$R[2]),
  ci.lb = c(Old_freezing_dur3$CI_emp$`2.5%`,Tall_freezing_dur3$CI_emp$`2.5%`, -0.20, within_between_freezing_dur_old$CI_emp[1,1], within_between_freezing_dur_old$CI_emp[2,1]),
  ci.ub = c(Old_freezing_dur3$CI_emp$`97.5%`,Tall_freezing_dur3$CI_emp$`97.5%`, 0.20,within_between_freezing_dur_old$CI_emp[1,2], within_between_freezing_dur_old$CI_emp[2,2]),
Endpoint = c("Time spent freezing", "Time spent freezing", "Time spent freezing","Time spent freezing","Time spent freezing"))
