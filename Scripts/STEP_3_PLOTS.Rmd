...
latency_rptr <- tibble(
  ...
  ci.lb = c(Old_latency$CI_emp$`2.5%`,Tall_latency$CI_emp$`2.5%`, 0.13,within_between_latency_old$CI_emp[1,1], within_between_latency_old$CI_emp[2,1],within_between_latency_tall$CI_emp[1,1], within_between_latency_tall$CI_emp[2,1]),
  ci.ub = c(Old_latency$CI_emp$`97.5%`,Tall_latency$CI_emp$`97.5%`, 0.58,within_between_latency_old$CI_emp[1,2], within_between_latency_old$CI_emp[2,2],within_between_latency_tall$CI_emp[1,2], within_between_latency_tall$CI_emp[2,2]),
