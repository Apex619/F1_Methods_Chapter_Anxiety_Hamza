...
Tot_Dist_rptr <- tibble(
  ...
  ci.lb = c(Old_Tot_Dist$CI_emp$`2.5%`,Tall_Tot_Dist$CI_emp$`2.5%`,-0.04, within_between_tot_dist_old$CI_emp[1,1], within_between_tot_dist_old$CI_emp[2,1],within_between_tot_dist_tall$CI_emp[1,1], within_between_tot_dist_tall$CI_emp[2,1]),
  ci.ub = c(Old_Tot_Dist$CI_emp$`97.5%`,Tall_Tot_Dist$CI_emp$`97.5%`, 0.37, within_between_tot_dist_old$CI_emp[1,2], within_between_tot_dist_old$CI_emp[2,2],within_between_tot_dist_tall$CI_emp[1,2], within_between_tot_dist_tall$CI_emp[2,2]),
...
low_dur_rptr <- tibble(
  ...
  ci.lb = c(Old_low_dur$CI_emp$`2.5%`,Tall_low_dur$CI_emp$`2.5%`, 0.013,within_between_low_dur_old$CI_emp[1,1], within_between_low_dur_old$CI_emp[2,1],within_between_low_dur_tall$CI_emp[1,1], within_between_low_dur_tall$CI_emp[2,1]),
...
frequency_rptr <- tibble(
  ...
  ci.lb = c(Old_freq_high$CI_emp$`2.5%`,Tall_freq_high$CI_emp$`2.5%`, -0.05,within_between_freq_high_old$CI_emp[1,1], within_between_freq_high_old$CI_emp[2,1],within_between_freq_high_tall$CI_emp[1,1], within_between_freq_high_tall$CI_emp[2,1]),
  ci.ub = c(Old_freq_high$CI_emp$`97.5%`,Tall_freq_high$CI_emp$`97.5%`, 0.31,within_between_freq_high_old$CI_emp[1,2], within_between_freq_high_old$CI_emp[2,2],within_between_freq_high_tall$CI_emp[1,2], within_between_freq_high_tall$CI_emp[2,2]),
...
latency_rptr <- tibble(
  ...
  ci.lb = c(Old_latency$CI_emp$`2.5%`,Tall_latency$CI_emp$`2.5%`, 0.15,within_between_latency_old$CI_emp[1,1], within_between_latency_old$CI_emp[2,1],within_between_latency_tall$CI_emp[1,1], within_between_latency_tall$CI_emp[2,1]),
