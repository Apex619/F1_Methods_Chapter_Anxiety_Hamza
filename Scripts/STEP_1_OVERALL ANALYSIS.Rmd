...
#TODO - shinichi is adding code for gettng between and within individual variances 
# 1 - we need to make all response variables to have the same unit - z transformation
rpt(scale(tot_dist) ~ (1 |  Fish_ID), grname = c("Fish_ID", "Residual"), data = Old_Tanks, datatype = "Gaussian", nboot = 100, npermut = 100, ratio = FALSE)
rpt(scale(tot_dist) ~ (1 |  Fish_ID), grname = c("Fish_ID", "Residual"), data = Tall_Tanks, datatype = "Gaussian", nboot = 100, npermut = 100, ratio = FALSE)
