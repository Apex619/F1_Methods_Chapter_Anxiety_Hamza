...
q2 <- quantile(Diff_boot_low_dur, c(0.025, 0.975)) # difference ditribuiton 95% CI
...
q3 <- quantile(Diff_boot_mid_dur, c(0.025, 0.975)) #2.5% crosses 0, not significant?
...
q4 <- quantile(Diff_boot_high_dur2, c(0.025, 0.975)) #2.5% crosses 0, not significant?
...
Tot_Dist_rptr <- tibble(
  Tank_Type = c("Short", "Tall", "Contrast"),
...
plot_low_dur_rptr <- ggplot(low_dur_rptr, aes(x=Tank_Type, y=r, colour=Tank_Type)) +
  ...
  labs(subtitle = "G. time spent in low zone")+
  coord_flip()+
   theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank())+
...
plot_mid_dur_rptr <- ggplot(mid_dur_rptr, aes(x=Tank_Type, y=r, colour=Tank_Type)) +
  ...
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
  labs(subtitle = "F .Time spent in middle zone")+
  coord_flip()+
   theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank())+
...
scale_color_manual(values=c("#000000", "#339900", "#FF9900"))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
  labs(subtitle = "E. Time spent in high zone")+
  coord_flip()+
   theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank())+
...
frequency_rptr <- tibble(
  Tank_Type = c("Short", "Tall", "Contrast"),
  r = c(Old_freq_high$R$Fish_ID,Tall_freq_high$R$Fish_ID, m6),
  ci.lb = c(Old_freq_high$CI_emp$`2.5%`,Tall_freq_high$CI_emp$`2.5%`, 0.14),
  ci.ub = c(Old_freq_high$CI_emp$`97.5%`,Tall_freq_high$CI_emp$`97.5%`, 0.57))
  
frequency_rptr

plot_frequency_rptr <- ggplot(frequency_rptr, aes(x=Tank_Type, y=r, colour=Tank_Type)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3), size=1.1) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3),size=3)+
scale_color_manual(values=c("#000000", "#339900", "#FF9900"))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
  labs(subtitle = "C. Entries into high zone")+
  coord_flip()+
   theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank())+
...
latency_rptr <- tibble(
  Tank_Type = c("Short", "Tall", "Contrast"),
  r = c(Old_latency$R$Fish_ID,Tall_latency$R$Fish_ID, m7),
  ci.lb = c(Old_latency$CI_emp$`2.5%`,Tall_latency$CI_emp$`2.5%`, -0.02),
  ci.ub = c(Old_latency$CI_emp$`97.5%`,Tall_latency$CI_emp$`97.5%`, 0.35))

plot_latency_rptr <- ggplot(latency_rptr, aes(x=Tank_Type, y=r, colour=Tank_Type)) +
  geom_errorbar(aes(ymin=ci.lb, ymax=ci.ub), width = 0, position = position_dodge(0.3), size=1.1) +
  geom_point(aes(x = Tank_Type, y = r), position = position_dodge(0.3),size=3)+
scale_color_manual(values=c("#000000", "#339900", "#FF9900"))+
  geom_hline(yintercept = 0, lty = "dotted") +
  labs(x = "Tank Type", y = "r") +
  labs(subtitle = "D. Latency to high")+
  coord_flip()+
   theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank())+
...
Violin_Dist <- ggplot(Anxiety_Joined, aes(x=Tank, y=tot_dist, fill=Tank)) + 
  ...
  labs(title="Total distance travelled: Tall vs Short",x="Tank type", y = "Total distance (cm)")
Violin_Dist + theme_classic()+
  facet_grid(~Sex)
...
Violin_Low <- ggplot(Anxiety_Joined, aes(x=Tank, y=low_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent in low zone: Tall vs Short",x="Tank type", y = "Time spent (seconds)")
Violin_Low + theme_classic()+
  facet_grid(~Sex)
...
Violin_Mid <- ggplot(Anxiety_Joined, aes(x=Tank, y=mid_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent in mid zone: Tall vs Short",x="Tank type", y = "Time spent (seconds)")
Violin_Mid + theme_classic()+
  facet_grid(~Sex)
...
Violin_High <- ggplot(Anxiety_Joined, aes(x=Tank, y=high_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent in high zone: Tall vs Short",x="Tank type", y = "Time spent (seconds)")
Violin_High + theme_classic()+
  facet_grid(~Sex)
...
Violin_Freezing <- ggplot(Anxiety_Joined, aes(x=Tank, y=freezing_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent freezing: Tall vs Short",x="Tank type", y = "Time spent (seconds)")
Violin_Freezing + theme_classic()+
  facet_grid(~Sex)

# Violin_Latency <- ggplot2.violinplot(data=Anxiety_Joined, xName='Tank',yName='latency_high', 
#     groupName='Tank',
#     groupColors=c('#999999','#E69F00'), showLegend=TRUE,
#     backgroundColor="white", xtitle="Tank", ytitle="Latency to high(s)", 
#     mainTitle="Latency to high zone: Tall vs Short",
#     addDot=FALSE, dotSize=0.3)+
#   facet_grid(~Sex)
# Violin_Latency
...
Violin_Latency + theme_classic()+
  facet_grid(~Sex)

# Violin_entries <- ggplot2.violinplot(data=Anxiety_Joined, xName='Tank',yName='freq_high', 
#     groupName='Tank',
#     groupColors=c('#999999','#E69F00'), showLegend=TRUE,
#     backgroundColor="white", xtitle="Tank", ytitle="Frequency to high zone", 
#     mainTitle="Frequency to high zone: Tall vs Short",
#     addDot=FALSE, dotSize=0.3)+
#   facet_grid(~Sex)
# Violin_entries
...
Violin_entries <- ggplot(Anxiety_Joined, aes(x=Tank, y=freq_high, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Frequency to high zone",x="Tank type", y = "Frequency")
Violin_entries + theme_classic()+
  facet_grid(~Sex)
```
