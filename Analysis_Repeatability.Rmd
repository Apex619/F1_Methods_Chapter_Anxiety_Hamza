...
Old_low_dur_Female <- rpt(tot_dist ~ (1 | Fish_ID), grname = "Fish_ID", data = Old_Tanks_Female, datatype = "Gaussian", 
    nboot = 1000, npermut = 1000)
Old_Tot_Dist_Female
plot(Old_Tot_Dist_Female)

Tall_Tot_Dist_Female <- rpt(tot_dist ~ (1 | Fish_ID), grname = "Fish_ID", data = Tall_Tanks_Female, datatype = "Gaussian", 
    nboot = 1000, npermut = 1000)
Tall_Tot_Dist_Female
tall_tot_dist_plot <- plot(Tall_Tot_Dist_Female)
...
tall_freezing_dur_plot <- plot(Tall_freezing_dur_Female)
