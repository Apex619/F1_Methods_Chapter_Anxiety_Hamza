...
Violin_Low <- ggplot(Anxiety_Joined, aes(x=Tank, y=low_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="C. Low zone",x="Tank type", y = "Time spent (seconds)")
...
Violin_Mid <- ggplot(Anxiety_Joined, aes(x=Tank, y=mid_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="B. Mid zone",x="Tank type", y = "Time spent (seconds)")
...
Violin_High <- ggplot(Anxiety_Joined, aes(x=Tank, y=high_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="A. High zone",x="Tank type", y = "Time spent (seconds)")
Violin_High + theme_classic()+
  facet_grid(~Sex)

ggsave(path = "Plots", file = "High_Durationt.jpeg", limitsize = FALSE)
...
Violin_Freezing <- ggplot(Anxiety_Joined, aes(x=Tank, y=freezing_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent freezing",x="Tank type", y = "Time spent (seconds)")
