...
sex_labs <- c("Female", "Male") # To rename facets
names(sex_labs) <- c("female", "male")

Violin_Dist <- ggplot(Anxiety_Joined, aes(x=Tank, y=tot_dist, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Total distance travelled",x="Tank type", y = "Total distance (cm)")+
theme_grey()+
...
Violin_Low <- ggplot(Anxiety_Joined, aes(x=Tank, y=low_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent in low zone",x="Tank type", y = "Time spent (seconds)")+
theme_grey()+
  facet_grid(~Sex, labeller = labeller(Sex = sex_labs))+
 theme(legend.position = "none")+
  scale_x_discrete(labels=c("Old" = "Short", "Tall" = "Tall"))
...
Violin_Mid <- ggplot(Anxiety_Joined, aes(x=Tank, y=mid_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent in middle zone",x="Tank type", y = "Time spent (seconds)")+
theme_grey()+
  facet_grid(~Sex, labeller = labeller(Sex = sex_labs))+
 theme(legend.position = "none")+
  scale_x_discrete(labels=c("Old" = "Short", "Tall" = "Tall"))
...
Violin_High <- ggplot(Anxiety_Joined, aes(x=Tank, y=high_dur, fill=Tank)) + 
  geom_violin(trim=FALSE)+
  geom_boxplot(width=0.1, fill="white")+
  labs(title="Time spent in high zone",x="Tank type", y = "Time spent (seconds)")+
theme_grey()+
  facet_grid(~Sex, labeller = labeller(Sex = sex_labs))+
 theme(legend.position = "none")+
  scale_x_discrete(labels=c("Old" = "Short", "Tall" = "Tall"))
...
Hist_entries <- ggplot(Anxiety_Joined, aes(y=freq_high, fill=Tank))+
  geom_histogram()+
  stat_bin(binwidth=6)+
theme_grey()+
  facet_grid(~Sex, labeller = labeller(Sex = sex_labs))+
  labs(title="Entries into the high zone",x="Counts", y = "Number of entries")+
  scale_fill_discrete(name = "Tank type", labels = c("Short","Tall"))+
  coord_flip()
