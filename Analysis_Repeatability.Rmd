...
plot_Tot_Dist_rptr <- ggplot(Tot_Dist_rptr, aes(x=Tank_Type, y=r, colour=Tank_Type)) +
  ...
  scale_color_manual(values=c("#339900", "#666666"))+
...
frequency_rptr <- tibble(
  Tank_Type = c("Short", "Tall"),
  r = c(Old_freq_high$R$Fish_ID,Tall_freq_high$R$Fish_ID),
  ci.lb = c(Old_freq_high$CI_emp$`2.5%`,Tall_freq_high$CI_emp$`2.5%`),
  ci.ub = c(Old_freq_high$CI_emp$`97.5%`,Tall_freq_high$CI_emp$`97.5%`))
...
latency_rptr <- tibble(
  Tank_Type = c("Short", "Tall"),
  r = c(Old_latency$R$Fish_ID,Tall_latency$R$Fish_ID),
  ci.lb = c(Old_latency$CI_emp$`2.5%`,Tall_latency$CI_emp$`2.5%`),
  ci.ub = c(Old_latency$CI_emp$`97.5%`,Tall_latency$CI_emp$`97.5%`))
